...
object ImageUtils {
    ...
    private const val SERVER_UPLOAD_PATH =
        "https://simple-file-server.herokuapp.com/files" //shared service URL
    ...
    fun uploadFile(fileUri: Uri) {
        ...
        Log.d(
            LOG_TAG,
            "onResponse - Status: ${response?.code()} Body: ${response?.body()?.string()}"
        )
    }
}